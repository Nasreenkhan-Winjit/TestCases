...
public class BaseDevTestForRestModule {
	...
	public void beforeSuite() {
		extent = ExtentManager.createInstance("~\\..\\Result\\BaseTestDevReport.html");
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("~\\..\\Result\\BaseTestDevReport.html");
		extent.attachReporter(htmlReporter);
		htmlReporter.config().setTheme(Theme.DARK);
		htmlReporter.config().setReportName("AutomationReport-BaseTestDevReport");
		htmlReporter.config().setDocumentTitle("AutomationReport-BaseTestDevReport");
...
//			 driver.findElementById("com.android.packageinstaller:id/permission_allow_button").click();
  ...
  public void PreRequisiteforrestOTHModule() throws InterruptedException {
	  ...
	  el22.sendKeys("DDISA15822179704");
